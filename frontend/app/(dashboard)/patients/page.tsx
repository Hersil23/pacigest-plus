        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div>
              ...
              <p className="text-[rgb(var(--gray-medium))] mt-1 text-sm md:text-base">
            ...
            <Link
              href="/patients/new"
              className="w-full md:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-[rgb(var(--primary))] text-white rounded-lg hover:bg-[rgb(var(--primary-hover))] transition-colors shadow-md"
            >
              <FaUserPlus />
